...
var submityn = true;
function hideOrShowSearchpanel()
{
	$(".hidequery").css("display",submityn?"none":"block");
	document.getElementById('hideOrShowSearchFlag').value = submityn;
	submityn= !submityn;
}
